...
class AMapController {
  ...
  void _connectStreams(int mapId) {
    ...
    _methodChannel.onMarkerMove(mapId: mapId).listen((MarkerMoveEvent e) => _mapState.onMarkerMove(e.value));

    _methodChannel.onClusterTap(mapId: mapId).listen((ClusterTapEvent e) => _mapState.onClusterTap(e.value));
